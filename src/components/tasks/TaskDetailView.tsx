  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 animate-in fade-in duration-300">
      <div className="flex-1 flex overflow-hidden">
        <div className="flex-1 overflow-y-auto min-w-0 border-r border-slate-800">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <div className="py-6">
                <TabsContent value="requirements" className="mt-0">
                  <div className="space-y-8">
                    <section>
                      ...
                      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 text-slate-300 leading-relaxed">
                        {task.description}
                      </div>
                    </section>
                      ...
                      <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
                        ...
                        {task.dependencies?.map((depId) => {
                          ...
                          return (
                            <div
                              key={depId}
                              className="flex items-center justify-between p-3 border-b border-slate-800 last:border-0 hover:bg-slate-800/50"
                            >
                    ...
                    <section>
                      ...
                      <div className="bg-slate-900 border border-slate-800 rounded-xl p-2">
                        {task.acceptanceCriteria?.map((criteria) => (
                          <div
                            key={criteria.id}
                            className="flex items-center p-3 hover:bg-slate-800/50 rounded-lg transition-colors group"
                          >
                            <div
                    ...
                    {mockDiffs.map((file, idx) => (
                      ...
                      >
                        <button
                          ...
                          className="w-full flex items-center justify-between p-3 bg-slate-900/50 hover:bg-slate-900 transition-colors border-b border-slate-800"
                        >
                          <div className="flex items-center space-x-2 text-sm font-mono text-slate-300">
                        ...
                        {openFiles[file.filename] && (
                          <div className="font-mono text-sm leading-6">
                            {file.lines.map((line, i) => (
                              ...
                              >
                                <div className="w-10 text-slate-600 text-right pr-3 select-none border-r border-slate-800/50 bg-slate-900/30">
                                  {line.line}
                                </div>
                                <div className="w-6 text-slate-600 text-center select-none">
                                  {line.type === 'add'
                                    ? '+'
                                    : line.type === 'remove'
                                      ? '-'
                ...
                <TabsContent value="pr" className="mt-0">
                  {!task.prCreated ? (
                    <div className="flex flex-col items-center justify-center h-64 text-slate-500 bg-slate-900/30 border border-slate-800 rounded-xl border-dashed">
                      ...
                      <button
                        ...
                        className="mt-4 text-blue-400 hover:text-blue-300 text-sm flex items-center hover:underline"
                      >
                    ...
                    <div className="space-y-6">
                      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                        <div className="mb-6">
                          ...
                          <div className="text-sm text-slate-400 flex items-center">
                            <span className="font-mono bg-slate-950 border border-slate-800 px-2 py-0.5 rounded text-slate-300 text-xs">
                        ...
                        <div className="divide-y divide-slate-800">
                          <div className="p-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                            <div className="flex items-center">
                              ...
                              />
                              <span className="text-slate-300">CI Build</span>
                            </div>
                          ...
                          <div className="p-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                            <div className="flex items-center">
                              <Bot size={18} className="text-blue-400 mr-3" />
                      ...
                      <div className="relative border-l border-slate-800 ml-3 space-y-6">
                        <div className="relative pl-6">
                          <div className="absolute -left-1.5 top-1.5 w-3 h-3 bg-slate-800 border border-slate-600 rounded-full"></div>
                      ...
                      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
                        ...
                        <div className="flex space-x-3">
                          <div className="w-8 h-8 rounded-full bg-blue-500/20 border border-blue-500/50 flex items-center justify-center text-blue-400 text-xs font-bold shrink-0">
                            ME
                          </div>
                ...
                <TabsContent value="ai-review" className="mt-0">
                  <div className="space-y-6">
                    <div className="bg-blue-950/30 border border-blue-900/50 rounded-xl p-5 text-blue-100 flex items-start space-x-4">
                      <Bot size={24} className="mt-1 flex-shrink-0 text-blue-400" />
                      <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-slate-900 p-5 rounded-xl border border-slate-800 flex flex-col items-center">
                        <div className="text-slate-500 text-xs uppercase font-semibold mb-2">
                          Security Score
                        </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {aiIssues.map((issue) => (
                          <div
                            key={issue.id}
                            className="bg-slate-900/50 border border-slate-800 rounded-lg p-4 flex items-start"
                          >
                            <div
                ...
                <TabsContent value="human-review" className="mt-0">
                  <div className="space-y-6">
                    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                      ...
                      <div className="bg-slate-950 rounded-lg border border-slate-800 p-4 mb-6 flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between p-4 bg-slate-950 rounded-lg border border-slate-800 mb-6">
                        <div className="flex items-center">
                          <div className="w-10 h-10 rounded-full bg-purple-500/20 border border-purple-500/50 flex items-center justify-center text-purple-400 font-bold mr-3">
                            JD
                          </div>
                          <div>
